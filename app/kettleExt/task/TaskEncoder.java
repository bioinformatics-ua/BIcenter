    ...
    public static mxGraph encode(Task task) throws Exception {
        ...
        try {
            ...
            for(Step step : steps){
                ...
                Object cell = graph.insertVertex(parent, null, stepValue, stepCell.getX(), stepCell.getY(), stepCell.getWidth(), stepCell.getHeight(), "icon;image=" + SvgImageUrl.getUrl("1", SvgImageUrl.Size_Middle));
