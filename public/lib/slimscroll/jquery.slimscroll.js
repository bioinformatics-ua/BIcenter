    ...
    $.fn.extend({
        slimScroll: function (options) {
            ...
            this.each(function () {
                    ...
                    if ($.isPlainObject(options)) {
                        ...
                        if ('width' in options && hasHorizontalScrollbar) {
                            if (options.width == 'auto') {
                                ...
                                var paddingLeft = me.parent().css('padding-left'),
                                    paddingRight = me.parent().css('padding-right');
                                ...
                                o.width = me.parent().parent().width() + padding;
                            }
                            else {
                            ...
                            _meCSS.width = o.width;
                            _meParentCSS.width = o.width;
                        }
                        ...
                        if ('height' in options && hasVerticalScrollbar) {
                            ...
                            _meCSS.height = o.height;
                            _meParentCSS.height = o.height;
                        }

                        // rewrap content
                        me.parent().css(_meParentCSS);
                ...
                o.width = (o.width == 'auto') ? me.parent().width() + padding : o.width;
